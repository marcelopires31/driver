...
u32 OS_SysGetDRAM_SEGMENT_MASK(void);
/*!\fn u32 OS_SysGetDRAM_SEGMENT_MASK(void)
 * \brief
 *
 * \return   DRAM segment address
 *
 * \code
 * \endcode
 */
...
u32 OS_SysGetMacroMIPS2DSPAddr(u32 u32mipsaddr);
/*!\fn u32 OS_SysGetMacroMIPS2DSPAddr(u32 u32mipsaddr)
 * \brief
 *
 * \return   MIPS to DSP addr
 *
 * \code
 * \endcode
 */
